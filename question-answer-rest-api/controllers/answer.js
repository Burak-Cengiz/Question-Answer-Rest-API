...
const getAllAnswersByQuestion = asyncErrorWrapper(async(req,res,next) => {
    ...
    const question = await Question.findById(question_id).populate("answers");//Populate ile o answer id sine göre bütün bilgileri getiricek
...
const getSingleAnswer = asyncErrorWrapper(async(req,res,next) => {
    ...
    .populate(
        ...
        ) ;//populate ile bütün bilgileri yerine bazı bilgileri göstermeyi seçtik
